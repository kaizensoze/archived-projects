server {
    listen   80;
    server_name boston.tastesavant.com;
    client_max_body_size 20M;

    access_log /var/log/nginx/access.boston.tastesavant.com.log;
    error_log /var/log/nginx/error.boston.tastesavant.com.log;
    ...
    location / {
        ...
        proxy_pass  http://boston.tastesavant.com;
    }
