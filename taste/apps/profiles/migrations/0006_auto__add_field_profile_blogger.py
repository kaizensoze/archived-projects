...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.blogger'
        db.add_column('profiles_profile', 'blogger', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.blogger'
        db.delete_column('profiles_profile', 'blogger')
