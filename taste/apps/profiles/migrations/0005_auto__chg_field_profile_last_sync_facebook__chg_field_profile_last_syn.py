...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.last_sync_facebook'
        db.alter_column('profiles_profile', 'last_sync_facebook', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Profile.last_sync_foursquare'
        db.alter_column('profiles_profile', 'last_sync_foursquare', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.last_sync_facebook'
        db.alter_column('profiles_profile', 'last_sync_facebook', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Profile.last_sync_foursquare'
        db.alter_column('profiles_profile', 'last_sync_foursquare', self.gf('django.db.models.fields.DateField')(null=True))
