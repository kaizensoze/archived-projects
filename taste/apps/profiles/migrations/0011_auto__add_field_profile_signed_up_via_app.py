...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.signed_up_via_app'
        db.add_column('profiles_profile', 'signed_up_via_app',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.signed_up_via_app'
        db.delete_column('profiles_profile', 'signed_up_via_app')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'digest_notifications': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            ...
            'signed_up_via_app': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
