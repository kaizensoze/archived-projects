...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('type_expert', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('type_reviewer', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('favorite_food', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('favorite_restaurant', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
