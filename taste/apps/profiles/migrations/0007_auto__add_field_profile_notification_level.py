...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.notification_level'
        db.add_column('profiles_profile', 'notification_level', self.gf('django.db.models.fields.CharField')(default='instant', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.notification_level'
        db.delete_column('profiles_profile', 'notification_level')
