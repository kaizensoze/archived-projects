...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for review in orm['reviews.Review'].objects.all():
            d = review.published
            if d:
                review.created = datetime.datetime(d.year, d.month, d.day, tzinfo=timezone)
                review.save()
            else:
                print str(review)
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
