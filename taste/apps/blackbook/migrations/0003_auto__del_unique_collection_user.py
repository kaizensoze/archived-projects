...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Collection', fields ['user']
        db.delete_unique('blackbook_collection', ['user_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Collection', fields ['user']
        db.create_unique('blackbook_collection', ['user_id'])
    ...
    models = {
        ...
        'blackbook.entry': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 17, 12, 20, 4, 661375)', 'auto_now': 'True', 'null': 'True', 'auto_now_add': 'True', 'blank': 'True'})
        },
