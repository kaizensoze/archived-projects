...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cuisine.position'
        db.alter_column('restaurants_cuisine', 'position', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Cuisine.position'
        db.alter_column('restaurants_cuisine', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())
