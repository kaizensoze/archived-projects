...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RestaurantImage.credit'
        db.add_column('restaurants_restaurantimage', 'credit', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RestaurantImage.credit'
        db.delete_column('restaurants_restaurantimage', 'credit')
