...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.kitchensurfing'
        db.add_column('restaurants_restaurant', 'kitchensurfing',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.kitchensurfing'
        db.delete_column('restaurants_restaurant', 'kitchensurfing')
    ...
    models = {
        ...
        'restaurants.restaurant': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kitchensurfing': ('django.db.models.fields.URLField', [], {'max_length': '2048', 'blank': 'True'}),
