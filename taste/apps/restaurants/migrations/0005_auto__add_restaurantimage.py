...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('restaurants_restaurantimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['restaurants.Restaurant'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('order_index', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('restaurants', ['RestaurantImage'])


    def backwards(self, orm):
        
        # Deleting model 'RestaurantImage'
        db.delete_table('restaurants_restaurantimage')
