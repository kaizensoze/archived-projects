...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('restaurants_restaurant', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Restaurant.slug'
        db.alter_column('restaurants_restaurant', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
