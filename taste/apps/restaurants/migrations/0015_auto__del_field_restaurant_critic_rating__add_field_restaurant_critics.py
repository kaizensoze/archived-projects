...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Restaurant.critic_rating'
        db.delete_column('restaurants_restaurant', 'critic_rating')

        # Adding field 'Restaurant.critics_say'
        db.add_column('restaurants_restaurant', 'critics_say',
                      self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'Restaurant.savants_say'
        db.add_column('restaurants_restaurant', 'savants_say',
                      self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=3, decimal_places=1),
                      keep_default=False)


        # Changing field 'Neighborhood.position'
        db.alter_column('restaurants_neighborhood', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Adding field 'Restaurant.critic_rating'
        db.add_column('restaurants_restaurant', 'critic_rating',
                      self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'Restaurant.critics_say'
        db.delete_column('restaurants_restaurant', 'critics_say')

        # Deleting field 'Restaurant.savants_say'
        db.delete_column('restaurants_restaurant', 'savants_say')


        # Changing field 'Neighborhood.position'
        db.alter_column('restaurants_neighborhood', 'position', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'restaurants.location': {
            ...
            'seamless_direct_url': ('django.db.models.fields.URLField', [], {'max_length': '2048', 'blank': 'True'}),
            'seamless_mobile_url': ('django.db.models.fields.URLField', [], {'max_length': '2048', 'blank': 'True'}),
        ...
        'restaurants.restaurant': {
            ...
            'critics_say': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '3', 'decimal_places': '1'}),
            ...
            'savants_say': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '3', 'decimal_places': '1'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
