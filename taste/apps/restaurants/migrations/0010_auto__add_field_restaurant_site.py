...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Restaurant.site'
        db.add_column('restaurants_restaurant', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.site'
        db.delete_column('restaurants_restaurant', 'site_id')
