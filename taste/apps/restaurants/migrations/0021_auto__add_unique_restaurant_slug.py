...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Restaurant', fields ['slug']
        db.create_unique('restaurants_restaurant', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Restaurant', fields ['slug']
        db.delete_unique('restaurants_restaurant', ['slug'])
