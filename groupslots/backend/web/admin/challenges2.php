...
<div class="col-left section" style="width: 400px;">
    <div class="section-title">
		Available Challenges
        <a class="button button-blue col-right" id="add-new" data-bind="click: addChallenge" href="#">
			Add New
	...
	<table class="table">
	<thead><tr>
        <th>Name</th><th>Challenge</th><th>Reward</th><th>Quantity</th><th>Active</th>
    </tr></thead>
	<tbody data-bind="foreach: challengeInstances">
		<tr>
			<td style="min-width: 140px;" data-bind="text: name"></td>
			<td style="min-width: 120px;" data-bind="text: $root.getChallengeName($data.challengeId)"></td>
			<td style="min-width: 140px;" data-bind="text: $root.getRewardName($data.rewardId)"></td>
			<td style="text-align: center;" data-bind="text: $root.getChallengeQuantity($data.challengeQuantity)"></td>
			<td style="text-align: center;" data-bind="text: $data.active == 1 ? 'yes' : 'no'"></td>
			<td><a href="#" data-bind="click: $root.editChallenge">Edit</a></td>
			<td><a href="#" data-bind="click: $root.removeChallenge">Remove</a></td>
		</tr>
	</tbody>
	</table>
</div>
