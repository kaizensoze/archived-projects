...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.affiliate'
        db.add_column('critics_site', 'affiliate', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.affiliate'
        db.delete_column('critics_site', 'affiliate')
