...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('critics_site', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.description'
        db.delete_column('critics_site', 'description')
