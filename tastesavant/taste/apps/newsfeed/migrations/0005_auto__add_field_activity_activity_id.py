...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.activity_id'
        db.add_column('newsfeed_activity', 'activity_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.activity_id'
        db.delete_column('newsfeed_activity', 'activity_id')
    ...
    models = {
        ...
        'newsfeed.activity': {
            ...
            'activity_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
