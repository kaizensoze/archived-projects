...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.occurred'
        db.alter_column('newsfeed_activity', 'occurred', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Activity.occurred'
        db.alter_column('newsfeed_activity', 'occurred', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
