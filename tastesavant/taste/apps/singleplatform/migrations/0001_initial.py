...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Menu'
        db.create_table('singleplatform_menu', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurants.Restaurant'])),
            ('sp_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('desc', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True)),
            ('footnote', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True)),
            ('state', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('disclaimer', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True)),
            ('attribution_image', self.gf('django.db.models.fields.URLField')(max_length=250)),
            ('attribution_image_link', self.gf('django.db.models.fields.URLField')(max_length=250)),
        ))
        db.send_create_signal('singleplatform', ['Menu'])

        # Adding model 'Entry'
        db.create_table('singleplatform_entry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['singleplatform.Menu'])),
            ('sp_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('desc', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True)),
            ('allergens', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('allergen_free', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('restrictions', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('spicy', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('singleplatform', ['Entry'])

        # Adding model 'Price'
        db.create_table('singleplatform_price', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['singleplatform.Entry'])),
            ('order_num', self.gf('django.db.models.fields.IntegerField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('calories', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('singleplatform', ['Price'])


    def backwards(self, orm):
        
        # Deleting model 'Menu'
        db.delete_table('singleplatform_menu')

        # Deleting model 'Entry'
        db.delete_table('singleplatform_entry')

        # Deleting model 'Price'
        db.delete_table('singleplatform_price')
    ...
    models = {
        ...
        'singleplatform.menu': {
            ...
            'desc': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'disclaimer': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
