...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.created_via_app'
        db.add_column('reviews_review', 'created_via_app',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.created_via_app'
        db.delete_column('reviews_review', 'created_via_app')
    ...
    models = {
        ...
        'reviews.review': {
            'Meta': {'ordering': "('-edited', 'restaurant__name')", 'object_name': 'Review'},
            ...
            'created_via_app': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
