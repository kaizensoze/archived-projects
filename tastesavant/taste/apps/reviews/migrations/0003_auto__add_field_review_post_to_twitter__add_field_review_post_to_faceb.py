...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.post_to_twitter'
        db.add_column('reviews_review', 'post_to_twitter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Review.post_to_facebook'
        db.add_column('reviews_review', 'post_to_facebook', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.post_to_twitter'
        db.delete_column('reviews_review', 'post_to_twitter')

        # Deleting field 'Review.post_to_facebook'
        db.delete_column('reviews_review', 'post_to_facebook')
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'published': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 12)', 'null': 'True', 'blank': 'True'}),
