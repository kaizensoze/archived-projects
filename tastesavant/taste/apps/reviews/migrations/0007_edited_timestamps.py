...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        We use .update particularly so that it won't get clonked by calling
        save.
        """
        orm['reviews.Review'].objects.update(edited=models.F('created'))

    def backwards(self, orm):
        """
        This is a no-op, because moving backwards, you'll be nuking the data
        anyway.
        """
        pass
