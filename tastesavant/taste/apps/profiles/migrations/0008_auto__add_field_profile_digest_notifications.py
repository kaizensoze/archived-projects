...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.digest_notifications'
        db.add_column('profiles_profile', 'digest_notifications', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.digest_notifications'
        db.delete_column('profiles_profile', 'digest_notifications')
