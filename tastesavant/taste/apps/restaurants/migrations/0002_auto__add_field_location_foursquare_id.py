...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.foursquare_id'
        db.add_column('restaurants_location', 'foursquare_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.foursquare_id'
        db.delete_column('restaurants_location', 'foursquare_id')
