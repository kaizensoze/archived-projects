...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('restaurants_restaurant', 'slug', self.gf('django.db.models.fields.SlugField')(default='bla', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.slug'
        db.delete_column('restaurants_restaurant', 'slug')
