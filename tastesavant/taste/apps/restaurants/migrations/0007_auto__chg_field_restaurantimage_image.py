...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RestaurantImage.image'
        db.alter_column('restaurants_restaurantimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'RestaurantImage.image'
        db.alter_column('restaurants_restaurantimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
