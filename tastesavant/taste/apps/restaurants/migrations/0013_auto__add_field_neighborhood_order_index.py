...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Neighborhood.order_index'
        db.add_column('restaurants_neighborhood', 'order_index',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Neighborhood.order_index'
        db.delete_column('restaurants_neighborhood', 'order_index')
    ...
    models = {
        ...
        'restaurants.neighborhood': {
            ...
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'order_index': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
