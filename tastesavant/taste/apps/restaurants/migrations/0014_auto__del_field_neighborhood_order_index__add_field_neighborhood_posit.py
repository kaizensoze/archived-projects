...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Neighborhood.order_index' to 'position'
        db.rename_column('restaurants_neighborhood', 'order_index', 'position')


    def backwards(self, orm):
        # Renaming field 'position' to 'Neighborhood.order_index'
        db.rename_column('restaurants_neighborhood', 'position', 'order_index')
