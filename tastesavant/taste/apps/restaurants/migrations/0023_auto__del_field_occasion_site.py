...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Occasion.site'
        db.delete_column('restaurants_occasion', 'site_id')

        # Adding M2M table for field site on 'Occasion'
        db.create_table('restaurants_occasion_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('occasion', models.ForeignKey(orm['restaurants.occasion'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('restaurants_occasion_site', ['occasion_id', 'site_id'])


    def backwards(self, orm):
        # Adding field 'Occasion.site'
        db.add_column('restaurants_occasion', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True),
                      keep_default=False)

        # Removing M2M table for field site on 'Occasion'
        db.delete_table('restaurants_occasion_site')
    ...
    models = {
        ...
        'restaurants.location': {
            ...
            'grubhub_url': ('django.db.models.fields.URLField', [], {'max_length': '2048', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
