...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.grubhub_url'
        db.add_column('restaurants_location', 'grubhub_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.grubhub_url'
        db.delete_column('restaurants_location', 'grubhub_url')
