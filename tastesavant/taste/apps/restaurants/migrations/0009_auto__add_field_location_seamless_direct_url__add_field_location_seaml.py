...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.seamless_direct_url'
        db.add_column('restaurants_location', 'seamless_direct_url', self.gf('django.db.models.fields.URLField')(default='', max_length=2048, blank=True), keep_default=False)

        # Adding field 'Location.seamless_mobile_url'
        db.add_column('restaurants_location', 'seamless_mobile_url', self.gf('django.db.models.fields.URLField')(default='', max_length=2048, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.seamless_direct_url'
        db.delete_column('restaurants_location', 'seamless_direct_url')

        # Deleting field 'Location.seamless_mobile_url'
        db.delete_column('restaurants_location', 'seamless_mobile_url')
