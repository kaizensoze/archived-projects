...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'OperatingHour', fields ['open', 'day', 'closed']
        db.delete_unique('restaurants_operatinghour', ['open', 'day', 'closed'])

        # Adding unique constraint on 'OperatingHour', fields ['open', 'day', 'closed', 'time_zone']
        db.create_unique('restaurants_operatinghour', ['open', 'day', 'closed', 'time_zone'])


    def backwards(self, orm):
        # Removing unique constraint on 'OperatingHour', fields ['open', 'day', 'closed', 'time_zone']
        db.delete_unique('restaurants_operatinghour', ['open', 'day', 'closed', 'time_zone'])

        # Adding unique constraint on 'OperatingHour', fields ['open', 'day', 'closed']
        db.create_unique('restaurants_operatinghour', ['open', 'day', 'closed'])
