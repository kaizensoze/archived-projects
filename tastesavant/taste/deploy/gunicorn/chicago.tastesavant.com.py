...
SITE_PACKAGES_PATH = path(VIRTUALENV_PATH,'www.tastesavant.com/lib/python2.6/site-packages')
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'taste.settings.production_chicago'
...
bind = "0.0.0.0:8012"
logfile = "/var/log/gunicorn/chicago.tastesavant.com.log"
workers = 3
timeout = 60 * 5
