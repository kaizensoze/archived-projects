...
- (void)refreshFacebookAccountsAndShareItem:(BFKNotePart *)item vc:(UIViewController *)vc {
    [self obtainAccessToFacebookAccountsWithBlock:^(BOOL granted, NSError *error) {
        dispatch_async(dispatch_get_main_queue(), ^{
            if (granted) {
                ...
                NSArray *items = @[[UIImage imageWithData:item.image]];
...
- (void)refreshTwitterAccountsAndShareImage:(BFKNotePart *)item vc:(UIViewController *)vc {
