...
//    [BFKDao saveSampleData];
//#endif
    
    // view deck
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Keeper" bundle:nil];
    
    UIViewController *notebooksVC = [storyboard instantiateViewControllerWithIdentifier:@"NotebooksNav"];
    UIViewController *sidebarVC = [storyboard instantiateViewControllerWithIdentifier:@"SidebarNav"];
    
    self.viewDeckController =  [[IIViewDeckController alloc] initWithCenterViewController:notebooksVC
...
//#if !(TARGET_IPHONE_SIMULATOR)
    // preload some view controllers
    self.captureVC = [storyboard instantiateViewControllerWithIdentifier:@"Capture"];
    __unused UIView *captureView = self.captureVC.view; // preload capture view
//#endif
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "baronfig.Keeper" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Keeper" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Keeper.sqlite"];
    NSError *error = nil;
